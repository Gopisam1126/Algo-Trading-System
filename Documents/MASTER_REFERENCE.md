...
| Tests | **1,508** — 368 of them security tests. Locally 1,261 pass and 247 are Docker-gated; CI runs the container tests too |
| Test coverage | **83%** statement/branch across `src/`, measured with the container tests skipped |
| Mutation testing | 95 injected defects across the safety-critical paths, **93 killed, 2 verified benign** |
...
| `execution/` | 🟡 **Risk engine started** (E14-S01 framework, E14-S02 pre-conditions 1–4, E14-S03 eligibility 5–7, E14-S04 exposure 8–10, E14-S05 loss limits 11–12). Still **no order placement and no sizing** — two of the fourteen checks are unwritten, so nothing can approve anything |
...
it changes what the test count means: 1,508 tests are claims about
