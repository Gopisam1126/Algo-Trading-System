...
| Tests | **1,580** — 379 of them security tests. Locally 1,333 pass and 247 are Docker-gated; CI runs the container tests too |
| Test coverage | **83%** statement/branch across `src/`, measured with the container tests skipped |
| Mutation testing | 110 injected defects across the safety-critical paths, **108 killed, 2 verified benign** |
...
| `execution/` | 🟡 **Risk engine started** (E14-S01 framework, E14-S02 pre-conditions 1–4, E14-S03 eligibility 5–7, E14-S04 exposure 8–10, E14-S05 loss limits 11–12, E14-S06 margin and timing 13–14). **All fourteen risk checks now exist**, and a real pipeline trigger clears them all — but there is still **no sizing and no order placement**, so the engine refuses rather than approving |
...
it changes what the test count means: 1,580 tests are claims about
